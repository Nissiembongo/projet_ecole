            ...
            <div class="card-body">
                <div class="d-flex justify-content-between">
                    <div>
                        ...
                        <h2 class="text-success"><?php echo number_format($stats['paiements'], 0, ',', ' '); ?> AOA</h2>
                        <p class="card-text">
                            <?php 
                            if (!empty($filtre_classe)) {
            ...
            <div class="card-body">
                <div class="d-flex justify-content-between">
                    <div>
                        ...
                        <h2 class="text-info"><?php echo number_format($stats['paiements_mois'], 0, ',', ' '); ?> AOA</h2>
                        <p class="card-text">
                            <?php 
                            if (!empty($filtre_classe)) {
                    ...
                    <?php if (count($paiements) > 0): ?>
                        ...
                        <div class="list-group-item">
                            <div class="d-flex w-100 justify-content-between">
                                ...
                                <small class="text-success"><?php echo number_format($paiement['montant_paye'], 0, ',', ' '); ?> AOA</small>
                            </div>
            ...
            tooltip: {
                callbacks: {
                    label: function(context) {
                        ...
                        return label + ': ' + value.toLocaleString() + ' AOA';
                    }
                }
            }
        }
